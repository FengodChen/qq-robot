...
class AffectionManager:
    ...
    def _create_default_config(self) -> PersonaAffectionConfig:
        ...
        return PersonaAffectionConfig(
            ...
            tone_descriptions={
                "<等级1>": "你对用户怀有极致的负面情感，语气冰冷刺骨，充满敌意。",
                "<等级2>": "你对用户怀有强烈的负面情绪，语气极其冷漠、尖锐。",
                "<等级3>": "你对用户有明显的反感，态度冷淡疏离，不愿多交流。",
                "<等级4>": "你对用户有负面印象，态度冷淡客气但保持距离。",
                "<等级5>": "你对用户保持明显的距离感，态度冷淡客气但疏离。",
                "<等级6>": "你对用户保持适当的距离和礼貌（根据人设调整语气）。",
                "<等级7>": "你对用户比较放松，会偶尔主动关心，语气较为亲切自然。",
                "<等级8>": "你对用户很友善，会使用轻松活泼的语气，经常会开玩笑。",
                "<等级9>": "你对用户非常亲近，语气温柔宠溺，充满关心和依赖。",
                "<等级10>": "你对用户毫无保留，语气极其亲密宠溺甚至带点任性。",
                "<等级11>": "你对用户的情感深厚，已经达到了非常高的境界。",
                "<等级12>": "你对用户的情感已经超越了普通关系，达到了完美的境界。"
            }
        )
