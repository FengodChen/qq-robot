...
- confirm(确认)：确认执行敏感操作，如"确认"、"确定"、"是的"
- cancel(取消)：取消待执行的敏感操作，如"取消"、"不"、"否"、"放弃"
...
用户："确认"
{"intent":"confirm","confidence":0.9,"parameters":{},"reason":"明确的确认操作指令"}

用户："取消"
{"intent":"cancel","confidence":0.9,"parameters":{},"reason":"明确的取消操作指令"}"""
